...
- WBS 15 완료 — 신규 개선은 [개인 실사용 백로그](docs/personal-backlog.md) triage 후 로드맵 승격
...
- [개인용 회귀 테스트 시나리오](docs/full-regression-test-scenarios.md) (WBS 13.10)
...
WBS 14 (개인 로컬 운영·점진 개선)는 14.1~14.8까지 완료했습니다. WBS 15 (개인 운영 안정화와 레거시 정리 2차)는 15.1~15.8까지 완료했습니다. WBS·백로그·로드맵은 [개발 WBS 및 로드맵](docs/development-roadmap.md)과 [AGENTS.md](AGENTS.md)를 단일 기준으로 봅니다.
