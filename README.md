...
2026-05-13 기준으로 NXT 전용 공개 REST API는 확인하지 못했습니다. 현재 한국 종목 시세는 `naver` provider 기준이며, KRX와 NXT 가격을 분리해서 보장하는 공식 provider가 아닙니다.
...
7. Expo 모바일 앱 초기 프로젝트 생성
8. App Store / Play Store 출시 준비
