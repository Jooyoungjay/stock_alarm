...
- WBS 16 **개인 운영 편의성 개선** — 16.1~16.6 완료, 다음 **16.7** 웹 시세 배너·오늘 할 일 ([로드맵](docs/development-roadmap.md) §16, [백로그](docs/personal-backlog.md), [wbs-16-evolution 스킬](.cursor/skills/wbs-16-evolution/SKILL.md))
...
WBS 14 (개인 로컬 운영·점진 개선)는 14.1~14.8까지 완료했습니다. WBS 15 (개인 운영 안정화와 레거시 정리 2차)는 15.1~15.8까지 완료했습니다. WBS 16 (개인 운영 편의성 개선)은 16.1~16.6 완료, 16.7~16.9 예정입니다. WBS·백로그·로드맵은 [개발 WBS 및 로드맵](docs/development-roadmap.md)과 [AGENTS.md](AGENTS.md)를 단일 기준으로 봅니다.
