...
날짜: 2026-06-24 (13.10·20.4·20.6 회귀·digest env 반영)
...
### 장중 today digest (WBS 19.5·20.6)

| 변수 | 기본값 | 설명 |
|---|---|---|
| `TODAY_ACTION_DIGEST_ENABLED` | `true` | 장중 critical 오늘 할 일 텔레그램 digest |
| `TODAY_ACTION_DIGEST_COOLDOWN_MINUTES` | `60` | 동일 항목 조합 재전송 대기(분) |
| `TODAY_ACTION_DIGEST_CHECK_INTERVAL_SECONDS` | `300` | digest 판단 주기(초) |

헬스 `lastTodayActionDigest`·주간 W-18과 함께 봅니다. 상세는 [개인 텔레그램 원격 운영](personal-telegram-operations.md).
